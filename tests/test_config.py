...
class ConfigMigrationTests(unittest.TestCase):
    def test_load_config_migrates_legacy_storage_to_user_app_dir(self):
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            legacy_root.mkdir()
            legacy_data_dir = legacy_root / "source"
                ...
                json.dumps(
                    {
                        ...
                        "remote_index_file": "source/remote/remote_index.faiss",
                        "remote_vector_file": "source/remote/remote_vectors.npy",
                    },
                    ensure_ascii=False,
                    indent=2,
                ),
            ...
            user_data_dir = user_root / "source"
