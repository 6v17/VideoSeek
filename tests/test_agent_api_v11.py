...
from src.services.agent_clip_service import execute_agent_export_clip, resolve_clip_window
...
class AgentClipServiceTests(unittest.TestCase):
    def test_resolve_clip_window_with_end(self):
        clip_start, clip_duration = resolve_clip_window("D:/a.mp4", 10.0, end_sec=15.0)
    ...
    @patch("src.services.agent_clip_service.get_video_duration_seconds", return_value=100.0)
