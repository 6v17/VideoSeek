...
DEFAULT_CONFIG = {
    ...
    "frame_neighbor_rerank_window_sec": 4.0,
    "image_pixel_rerank_enabled": True,
    "image_pixel_rerank_top_n": 20,
    "image_pixel_rerank_min_similarity": 0.58,
    "image_pixel_rerank_time_window_sec": 2.0,
    "image_pixel_rerank_probe_mode": "index",
    "image_pixel_rerank_probe_step_sec": 0.5,
    "image_search_fetch_multiplier": 3,
    "preview_seconds": 6,
    "preview_width": 640,
    "preview_height": 360,
...
CONFIG_BOUNDS = {
    ...
    "image_pixel_rerank_min_similarity": (0.0, 1.0),
...
CONFIG_ENUMS = {
    ...
    "search_results_view_mode": {"table", "grid"},
    "theme": {"dark", "light"},
    "language": {"zh", "en"},
