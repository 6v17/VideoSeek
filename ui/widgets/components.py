...
class UnderstandingEvidencePage(QWidget):
    def __init__(self, parent=None):
        ...
        config_form.addWidget(self.label_remote_vlm_base_url, 1, 0)
        config_form.addWidget(self.input_remote_vlm_base_url, 1, 1)
        ...
        config_form.addWidget(self.label_remote_vlm_model, 2, 0)
        config_form.addWidget(self.input_remote_vlm_model, 2, 1)
        ...
        config_form.addWidget(self.label_caption_language, 3, 0)
        config_form.addWidget(self.input_caption_language, 3, 1)
        ...
        workspace_layout.addWidget(self.chunk_timeline)
        ...
        self.chunk_time_label.setObjectName("CardHint")
        self.chunk_time_label.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        segment_header.addWidget(self.chunk_detail_title, 0)
        segment_header.addWidget(self.chunk_time_label, 1)
        segment_header_host = QWidget()
        segment_header_host.setLayout(segment_header)
        detail_grid.addWidget(segment_header_host, 0, 0)
        ...
        detail_grid.addWidget(summary_header_host, 0, 1)
        ...
        detail_grid.addWidget(self.chunk_caption_text, 1, 0)
        ...
        detail_grid.addWidget(self.video_summary_text, 1, 1)
        detail_grid.setRowStretch(1, 1)
        ...
        detail_grid.addWidget(self.chunk_objects_label, 2, 0)
        ...
        detail_grid.addWidget(self.video_summary_meta_label, 2, 1)
